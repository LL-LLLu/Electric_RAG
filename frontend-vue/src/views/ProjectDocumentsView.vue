...
import { ArrowLeftIcon, CloudArrowUpIcon, DocumentTextIcon } from '@heroicons/vue/24/outline'
  ...
  <div class="project-documents min-h-screen bg-gray-50">
    <div class="container mx-auto px-4 py-8">
      ...
      <div v-else class="text-center py-16 bg-white rounded-lg border border-gray-200">
        ...
        <h3 class="text-lg font-medium text-gray-900 mb-2">Documents Management</h3>
